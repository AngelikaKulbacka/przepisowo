...
@section('content')
    <div class="container">
        <form enctype="multipart/form-data" action="{{ route('recipe.edit', ['recipe' => $recipe->id]) }}" method="POST">
            @csrf
            @method('PATCH')
            ...
            <div class="row">
                <div class="">
                    ...
                    <button type="submit" class="mx-2 float-end btn btn-primary">Zapisz zmiany</button>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <input @if (old('is_private') ?? $recipe->czy_prywatne) checked @endif type="checkbox" name="is_private" id="is_private" value="1">
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col">
                    <div class="form-group my-2">
                        ...
                        <input value="{{ old('recipeName') ?? $recipe->nazwa}}" type="text" class="form-control @if($errors->any()) @if($errors->has('recipeName')) is-invalid @else is-valid @endif @endif" name="recipeName">
                    ...
                    <div class="form-group my-2">
                        ...
                        <textarea class="form-control @if($errors->any()) @if($errors->has('shortDescription')) is-invalid @else is-valid @endif @endif" name="shortDescription" style="resize: none;" rows="4">{{ old('shortDescription') ?? $recipe->opis_przygotowania }}</textarea>
                        <div class="invalid-feedback">
                ...
                <div class="col">
                    ...
                    @forelse (old('ingredient') ?? $recipe->ingredients->pluck('skladnik') ?? [] as $i => $ingredient)
                        <div class="form-group my-2">
            ...
            <div class="row">
                <div class="col">
                    <div class="form-group my-2">
                        ...
                        <textarea class="form-control @if($errors->any()) @if($errors->has('steps.0')) is-invalid @else is-valid @endif @endif" name="steps[]" style="resize: none;" rows="4">{{ old('steps.0') ?? $recipe->steps->pluck('opis')->first() }}</textarea>
                        <div class="invalid-feedback">
            ...
            @foreach (array_slice(old('steps') ?? $recipe->steps->pluck('opis')->toArray() ?? [], 1) as $i=>$step)
                <div class="row stepClone">
                    <div class="col">
                        <div class="form-group my-2">
